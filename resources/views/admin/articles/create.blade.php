            ...
            <div class="grid grid-cols-1 xl:grid-cols-12 lg:grid-cols-8 gap-6">
                ...
                <div class="xl:col-span-8 lg:col-span-5 space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-200/60 p-6 hover:shadow-md transition-all duration-300">
                        <div class="flex items-center space-x-2 mb-4">
                            ...
                            <h3 class="text-lg font-semibold text-gray-900 -ml-2">Judul Artikel</h3>
                        </div>
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-200/60 p-6 hover:shadow-md transition-all duration-300">
                        <div class="flex items-center space-x-2 mb-4">
                            ...
                            <h3 class="text-lg font-semibold text-gray-900 -ml-2">Ringkasan</h3>
                            <span class="px-2 py-1 text-xs font-medium bg-gray-100 text-gray-600 rounded-md">Opsional</span>
                        </div>
                        <textarea id="excerpt" name="excerpt" rows="3"
                                  style="border-color: #e5e7eb; focus:border-color: #7E2320; focus:ring-color: #7E2320;"
                                  class="block w-full rounded-xl border-2 shadow-sm focus:ring-2 focus:ring-opacity-20 sm:text-sm transition-all duration-200 placeholder-gray-400 py-3 px-4 @error('excerpt') border-red-500 @enderror"
                                  placeholder="Tulis ringkasan singkat yang menarik untuk artikel Anda...">{{ old('excerpt') }}</textarea>
                        @error('excerpt')
                            <p class="mt-2 text-sm text-red-600 flex items-center">
                                <svg class="w-4 h-4 mr-1" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zM9 9a1 1 0 000 2v3a1 1 0 001 1h1a1 1 0 100-2v-3a1 1 0 00-1-1H9z" clip-rule="evenodd" />
                    ...
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-200/60 p-6 hover:shadow-md transition-all duration-300">
                        <div class="flex items-center space-x-2 mb-4">
                            ...
                            <h3 class="text-lg font-semibold text-gray-900 -ml-2">Konten Artikel</h3>
                ...
                <div class="xl:col-span-4 lg:col-span-3 space-y-4">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200/60 p-4 hover:shadow-md transition-all duration-300">
                        <div class="flex items-center space-x-2 mb-4">
                            <div class="w-6 h-6 rounded-lg bg-gradient-to-r from-purple-400 to-pink-500 flex items-center justify-center">
                                <svg class="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                            </div>
                            <h3 class="text-base font-semibold text-gray-900 -ml-2">Status</h3>
                        </div>
                        <div class="space-y-2">
                            <label class="relative flex items-center p-2 rounded-lg border-2 border-gray-200 cursor-pointer hover:border-gray-300 transition-colors duration-200 has-[:checked]:border-yellow-400 has-[:checked]:bg-yellow-50">
                                <input type="radio" name="status" value="draft" 
                                       {{ old('status', 'draft') == 'draft' ? 'checked' : '' }}
                                       class="sr-only peer">
                                <div class="flex items-center space-x-2">
                                    <div class="w-3 h-3 rounded-full border-2 border-gray-300 peer-checked:border-yellow-500 peer-checked:bg-yellow-500 flex items-center justify-center">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-xs text-gray-500">Simpan untuk diedit nanti</p>
                                    </div>
                                </div>
                            </label>
                            <label class="relative flex items-center p-2 rounded-lg border-2 border-gray-200 cursor-pointer hover:border-gray-300 transition-colors duration-200 has-[:checked]:border-green-400 has-[:checked]:bg-green-50">
                                <input type="radio" name="status" value="published"
                                       {{ old('status') == 'published' ? 'checked' : '' }}
                                       class="sr-only peer">
                                <div class="flex items-center space-x-2">
                                    <div class="w-3 h-3 rounded-full border-2 border-gray-300 peer-checked:border-green-500 peer-checked:bg-green-500 flex items-center justify-center">
                                        <div class="w-1.5 h-1.5 rounded-full bg-white opacity-0 peer-checked:opacity-100"></div>
                                    </div>
                                    <div>
                                        <span class="text-sm font-medium text-gray-900">Publish</span>
                                        <p class="text-xs text-gray-500">Terbitkan sekarang</p>
                                    </div>
                                </div>
                            </label>
                        </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200/60 p-4 hover:shadow-md transition-all duration-300">
                        <div class="flex items-center space-x-2 mb-4">
                            ...
                            <h3 class="text-base font-semibold text-gray-900 -ml-2">Kategori</h3>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200/60 p-4 hover:shadow-md transition-all duration-300">
                        <div class="flex items-center space-x-2 mb-4">
                            ...
                            <h3 class="text-base font-semibold text-gray-900 -ml-2">Gambar</h3>
                        </div>
                        <div class="relative">
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200/60 p-4 hover:shadow-md transition-all duration-300">
                        <div class="flex items-center space-x-2 mb-4">
                            <div class="w-6 h-6 rounded-lg bg-gradient-to-r from-cyan-400 to-blue-500 flex items-center justify-center">
                                <svg class="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M5.25 8.25h15m-16.5 7.5h15m-1.5-13.5L3.75 7.5l1.5 13.5L19.5 7.5 18 21l-7.5-6L3 21l1.5-13.5z" />
                                </svg>
                            </div>
                            <h3 class="text-base font-semibold text-gray-900 -ml-2">Tags</h3>
                        </div>
                        <input type="text" id="tags" name="tags" 
                               value="{{ old('tags') }}"
                               style="border-color: #e5e7eb; focus:border-color: #7E2320; focus:ring-color: #7E2320;"
                               class="block w-full rounded-lg border-2 shadow-sm focus:ring-2 focus:ring-opacity-20 text-sm transition-all px-4 py-2 duration-200 placeholder-gray-400"
                               placeholder="teknologi, politik">
                        <p class="mt-1 text-xs text-gray-500">Pisahkan dengan koma</p>
                    </div>

                    <!-- Quick Actions Card -->
                    <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl border border-gray-200/60 p-4">
                        ...
                        <div class="space-y-2">
                            <button type="button" 
                                    ...
                                    class="w-full text-left px-3 py-2 text-sm text-gray-600 hover:text-gray-900 hover:bg-white rounded-lg transition-colors duration-200">
                                📝 Focus Editor
                            </button>
                            <button type="button" 
                    ...
                    <!-- Article Stats (for motivation) -->
                    <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-xl border border-blue-200/60 p-4">
                        <h3 class="text-sm font-semibold text-blue-900 mb-2">📊 Writing Progress</h3>
                        ...
                        <p class="mt-2 text-xs text-gray-500">Pisahkan dengan koma untuk multiple tags</p>
                    </div>
                </div>
            </div>
    ...
    fileInput.addEventListener('change', function(e) {
        ...
        if (file) {
            ...
            reader.onload = function(e) {
                ...
                `;
                uploadArea.querySelector('.border-dashed').replaceWith(preview);
            };
