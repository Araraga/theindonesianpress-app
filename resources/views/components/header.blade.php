    ...
    <div class="w-full flex justify-center py-3 px-4 gap-2 md:gap-4 z-0 relative">
        <ul class="flex flex-row gap-2 md:gap-4 text-sm font-semibold items-center w-auto mx-auto" style="color:#FEFEFE !important; flex-wrap:nowrap;">
            ...
            @foreach($categories as $cat)
                <li><a href="{{ route('dashboard', ['category' => $cat->id]) }}" class="nav-link px-3 py-1.5 rounded transition" style="color:#FEFEFE !important;" onmouseover="this.style.background='#FEFEFE';this.style.color='#171717';" onmouseout="this.style.background='';this.style.color='#FEFEFE';">{{ $cat->name }}</a></li>
            @endforeach
