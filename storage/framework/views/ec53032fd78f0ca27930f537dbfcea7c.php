...
<nav class="w-full bg-white/90 border-b border-neutral-200 shadow z-50 sticky top-0 backdrop-blur" style="z-index:9999 !important;">
    <div class="w-full max-w-[900px] mx-auto flex flex-wrap justify-center py-3 px-4 gap-2 md:gap-4 z-0 relative">
        <ul class="flex flex-wrap justify-center gap-2 md:gap-4 text-sm font-semibold text-gray-800 items-center">
            <li><a href="<?php echo e(route('dashboard')); ?>" class="nav-link px-3 py-1.5 rounded hover:bg-blue-50 transition">Beranda</a></li>
            <li><a href="<?php echo e(route('dashboard', ['genre' => 'bisnis'])); ?>" class="nav-link px-3 py-1.5 rounded hover:bg-blue-50 transition" data-content="bisnis">Bisnis & Tenaga Kerja</a></li>
            <li><a href="<?php echo e(route('dashboard', ['genre' => 'opini'])); ?>" class="nav-link px-3 py-1.5 rounded hover:bg-blue-50 transition" data-content="opini">Opini</a></li>
            <li><a href="<?php echo e(route('dashboard', ['genre' => 'seni'])); ?>" class="nav-link px-3 py-1.5 rounded hover:bg-blue-50 transition" data-content="seni">Seni & Budaya</a></li>
            <li><a href="<?php echo e(route('dashboard', ['genre' => 'sains'])); ?>" class="nav-link px-3 py-1.5 rounded hover:bg-blue-50 transition" data-content="sains">Sains</a></li>
            <li><a href="<?php echo e(route('dashboard', ['genre' => 'olahraga'])); ?>" class="nav-link px-3 py-1.5 rounded hover:bg-blue-50 transition" data-content="olahraga">Olahraga</a></li>
            <li><a href="<?php echo e(route('dashboard', ['genre' => 'foto'])); ?>" class="nav-link px-3 py-1.5 rounded hover:bg-blue-50 transition" data-content="foto">Foto</a></li>
            <li><a href="<?php echo e(route('dashboard', ['genre' => 'ilustrasi'])); ?>" class="nav-link px-3 py-1.5 rounded hover:bg-blue-50 transition" data-content="ilustrasi">Ilustrasi</a></li>
            <li><a href="<?php echo e(route('dashboard', ['genre' => 'video'])); ?>" class="nav-link px-3 py-1.5 rounded hover:bg-blue-50 transition" data-content="video">Video</a></li>
            <li><a href="<?php echo e(route('dashboard', ['genre' => 'majalah'])); ?>" class="nav-link px-3 py-1.5 rounded hover:bg-blue-50 transition" data-content="majalah">Majalah</a></li>
            <li><a href="<?php echo e(route('dashboard', ['genre' => 'teka-teki'])); ?>" class="nav-link px-3 py-1.5 rounded hover:bg-blue-50 transition" data-content="teka-teki">Teka-Teki</a></li>
            <li><a href="<?php echo e(route('artikel.create')); ?>" class="px-3 py-1.5 rounded bg-blue-600 text-white transition">Tulis Artikel</a></li>
            <li><a href="<?php echo e(route('bookmarks')); ?>" class="nav-link px-3 py-1.5 rounded hover:bg-yellow-100 text-yellow-800 font-bold transition flex items-center gap-2"><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" style="color:#b45309 !important;"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 5v14l7-7 7 7V5a2 2 0 00-2-2H7a2 2 0 00-2 2z" /></svg>Bookmark</a></li>
            <li class="ml-2">
                <div class="relative">
                    ...
                    <div id="profile-menu" class="hidden absolute left-1/2 -translate-x-1/2 mt-6 w-48 bg-white rounded-xl shadow-lg border border-blue-100 z-[1050] py-2">
                        <a href="<?php echo e(route('settings.profile')); ?>" class="block px-6 py-3 text-gray-800 hover:bg-blue-50 font-semibold">Pengaturan Akun</a>
