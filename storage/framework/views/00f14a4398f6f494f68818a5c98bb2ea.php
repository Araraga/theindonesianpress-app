                    ...
                    <div class="mt-5 w-full max-w-lg">
                        <form wire:submit="updateProfileInformation" class="my-6 w-full space-y-8">
                            ...
                            <div class="flex justify-between mt-8">
                                <a href="#" onclick="window.history.length > 1 ? window.history.back() : window.location='<?php echo e(route('dashboard')); ?>'; return false;" class="px-8 py-3 rounded-lg font-bold text-lg shadow transition" style="background:#e0e7ff !important; color:#1e40af !important; border:2px solid #1e40af !important;">Kembali</a>
