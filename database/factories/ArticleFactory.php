    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'genre' => fake()->randomElement([
                'Bisnis & Tenaga Kerja', 'Seni & Budaya', 'Sains', 'Olahraga', 'Foto', 'Ilustrasi', 'Video', 'Majalah', 'Teka-Teki', 'Opini', 'Ekonomi', 'Teknologi', 'Hiburan', 'Kesehatan', 'Pendidikan', 'Lingkungan', 'Politik'
            ]),
            ...
            'subheadline' => fake()->sentence(rand(6, 12)),
        ];
    }
